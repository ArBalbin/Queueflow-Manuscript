...
\textbf{Training Result.} After cleaning and wait-time reconstruction,
the prepared dataset contained 30,362 supervised rows. Applying the
one-minute minimum-wait filter left 19,119 modeling rows. The
date-based split produced 13,031 training rows and 6,088 test rows.
The training period covered May~24,~2023 to January~20,~2026, and the
test period covered January~21,~2026 to May~4,~2026. On the test set,
the Gradient Boosting model obtained MAE~=~2.3512 minutes,
RMSE~=~4.0858 minutes, MAPE~=~80.74\%, and $R^2=-0.0349$. The MAE and
RMSE are used as the main accuracy indicators, while MAPE is reported
with caution because short reconstructed waits inflate percentage
error.
...
\section*{Archie D. Balbin}

\noindent Archie D. Balbin is a candidate for the degree Bachelor of
Science in Computer Science at Naga College Foundation, Inc., Naga
City. He is one of the researchers of the capstone project entitled
\textit{QueueFlow: Computer Vision Based Automated Queue Ticket
Assignment and Real-Time Predictive System for Dynamic Campus Service
Delivery}.

\vspace{1em}
\noindent
\begin{tabular}{p{0.28\textwidth} p{0.64\textwidth}}
\textbf{Name} & Archie D. Balbin \\
\textbf{Degree Program} & Bachelor of Science in Computer Science \\
\textbf{Institution} & Naga College Foundation, Inc. \\
\textbf{College} & College of Computer Studies \\
\textbf{Capstone Focus} & Computer vision, queue management, ticket
assignment, and wait-time prediction \\
\textbf{Adviser} & Fritzgerald Enric T. Imperial, MIT \\
\end{tabular}

\newpage

\section*{Joshua Rovic P. Sanota}

\noindent Joshua Rovic P. Sanota is a candidate for the degree Bachelor
of Science in Computer Science at Naga College Foundation, Inc., Naga
City. He is one of the researchers of the capstone project entitled
\textit{QueueFlow: Computer Vision Based Automated Queue Ticket
Assignment and Real-Time Predictive System for Dynamic Campus Service
Delivery}.
...
\noindent
\begin{tabular}{p{0.28\textwidth} p{0.64\textwidth}}
\textbf{Name} & Joshua Rovic P. Sanota \\
\textbf{Degree Program} & Bachelor of Science in Computer Science \\
\textbf{Institution} & Naga College Foundation, Inc. \\
\textbf{College} & College of Computer Studies \\
\textbf{Capstone Focus} & Computer vision, queue management, ticket
