...
This study uses total enumeration for service staff and
administrators, and convenience sampling for students, adapted to the
supervised trial session in which the system is evaluated. Sampling is adapted to the
...
\begin{enumerate}
  ...
  \item For staff and administrators only -- Your role during the
        session:
        $\square$ Operated the staff dashboard \quad
        $\square$ Observed or supervised
\end{enumerate}

\section*{Instructions}

Answer only the form for your group: students answer Section~II, and
staff and administrators answer Section~III. For each statement, choose
...
\clearpage
\section*{Section III: Staff and Administrator Form}

\begin{table}[H]
\small
\caption{Staff and administrator form (15 items).}
