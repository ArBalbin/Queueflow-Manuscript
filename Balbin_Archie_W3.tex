...
detector can locate bounding boxes, but it does not decide whether a box
represents a new entrant, a duplicate track, a returning student, or a
person who should keep an existing queue number. For this reason,
...
of this build. The evaluation is limited to one semester after
implementation.
...
the questionnaire is administered to the full sample. The baseline
...
\textbf{5} & \textbf{4} & \textbf{3} & \textbf{2} & \textbf{1} \\
\midrule
B1 & \sysname{} correctly recognizes enrolled students and issues their
queue numbers. & [S] [A] [ST] &
\ratingbox & \ratingbox & \ratingbox & \ratingbox & \ratingbox \\
...
\ratingbox & \ratingbox & \ratingbox & \ratingbox & \ratingbox \\
B4 & The dashboard shows clearly when the person whose turn it is has
left the queue area. & [S] &
\ratingbox & \ratingbox & \ratingbox & \ratingbox & \ratingbox \\
...
\ratingbox & \ratingbox & \ratingbox & \ratingbox & \ratingbox \\
C4 & Pending-link alerts and counter controls are clearly labeled and
visible. & [S] &
\ratingbox & \ratingbox & \ratingbox & \ratingbox & \ratingbox \\
