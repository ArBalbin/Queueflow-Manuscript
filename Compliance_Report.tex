...
identified the population as the two groups who use the system: the
cashier staff and the students who transact at the office. The number
in each group is to be confirmed with NCF administration before
deployment.
&
...
&
Stated the techniques used: total enumeration for cashier staff,
and convenience sampling for students in both the
baseline survey and the supervised trial session.
&
